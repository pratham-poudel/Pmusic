...
export function Favourite() {
    ...
    const fetchResults = async () => {
        try {
            const response = await fetch('/favourites'); // Assuming your backend endpoint is '/api/profile'
            if (response.ok) {
            ...
            <Card className="mt-6 w-96">
                <CardHeader color="blue-gray" className="relative h-56">
                    <img className="w-full h-full object-cover"
                        src="https://images.hdqwalls.com/wallpapers/taylor-swift-2018-4k-kg.jpg"
                        alt="card-image"
                    />
                </CardHeader>
                <CardBody>
                ...
                <CardFooter className="pt-0">
                    <Button onClick={fetchResults}>View Favourites</Button>
                </CardFooter>
